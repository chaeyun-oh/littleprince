...
function myFunction() {
 ...
 var poet = " ";
 var poetArr = poet.split("<br> <br>And now here is my secret,<br> <br> a very simple secret:<br> <br> It is only with the heart that one can see rightly;<br> <br>  what is essential is invisible to the eye.  ");

var myTimer = setInterval(print,1100);
var s=0;
function print(){
